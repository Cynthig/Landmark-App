...
public class Item3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnMuizenberg = findViewById(R.id.btnMuizenberg);

        sSource = "628 Reitz St, Sunnyside, Pretoria, 0002";
        sDestination = "Muizenberg Beach";

        btnMuizenberg.setOnClickListener(new View.OnClickListener() {
            @Override
